...
class Conv2d_cd(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding=1, dilation=1, groups=1, theta=0.1):
...
class SimpleDecoding(nn.Module):
    def __init__(self, c4_dims, factor=2):
        ...
        self.conv1_4 = Conv2d_cd(c4_size+c3_size,hidden_size,kernel_size=3, stride=1)
        # self.conv1_4 = nn.Conv2d(c4_size+c3_size, hidden_size, 3, padding=1, bias=False)
        self.bn1_4 = nn.BatchNorm2d(hidden_size)
        self.relu1_4 = nn.ReLU()
        self.conv2_4 = Conv2d_cd(hidden_size, hidden_size,kernel_size=3, stride=1)
        self.bn2_4 = nn.BatchNorm2d(hidden_size)
        self.relu2_4 = nn.ReLU()

        self.conv1_3 = Conv2d_cd(hidden_size + c2_size, hidden_size, kernel_size=3, stride=1)
        self.bn1_3 = nn.BatchNorm2d(hidden_size)
        self.relu1_3 = nn.ReLU()
        self.conv2_3 = Conv2d_cd(hidden_size, hidden_size, kernel_size=3, stride=1)
        self.bn2_3 = nn.BatchNorm2d(hidden_size)
        self.relu2_3 = nn.ReLU()

        self.conv1_2 = Conv2d_cd(hidden_size + c1_size, hidden_size,kernel_size=3, stride=1)
        self.bn1_2 = nn.BatchNorm2d(hidden_size)
        self.relu1_2 = nn.ReLU()
        self.conv2_2 = Conv2d_cd(hidden_size, hidden_size,kernel_size=3, stride=1)
